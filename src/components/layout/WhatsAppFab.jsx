...
// An <a>, not a <button> with window.open: this is a navigation, so the anchor
// gets keyboard activation, middle-click and open-in-new-tab for free, and it
...
export function WhatsAppFab() {
  return (
    <a
      ...
      aria-label={LABEL}
    >
      {/* The visible text matches aria-label exactly, so SC 2.5.3 (Label in Name)
          holds for anyone driving the page by voice. */}
